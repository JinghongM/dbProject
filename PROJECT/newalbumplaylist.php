        ...
        <div class="btn-group">
                           ...
                           <table class="table table-inbox table-hover">
                            <tr>
                                ...
                                <th class="view-message  dont-show">Title</th>
                             ...
                             function changeAuthorization($Authorization)
                             {
                              ...
                              else
                              {
                                return "For everyone";
                                  ...
                                  $conn = new mysqli($servername, $username, $password, $dbname);
                                  $sql1 = "SELECT album.albumID,album.atitle,album.IssueDate
                                           FROM album
                                           ORDER BY IssueDate DESC LIMIT 50";
                                  ...
                                  while($row = $result1->fetch_assoc())
                                  {
                                    echo '<tr>
                                      ...
                                      <td class="view-message  dont-show"> <a href="myplaylist.php?user='.$Username.'&albumid='.$row["albumID"].'">'.$row["atitle"].'</a></td>
